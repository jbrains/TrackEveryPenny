...
public class TransactionCsvFormat {
    public String format(Transaction transaction) {
        ...
        final String categoryText = (transaction.categoryName == null) ? "" : transaction.categoryName;
        return String.format("\"%1$s\",\"%2$s\",\"%3$.2f\"", dateText, categoryText, amountInDollars);
    }
}
